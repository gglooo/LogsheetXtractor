...
public class StartBatchLogsheetProcessingCommandHandlerTests : IDisposable
{
    ...
    {
        var logsheet1 = new Logsheet { Id = Guid.NewGuid(), Status = ELogSheetStatus.Pending, Template = null!, File = null! };
        var logsheet2 = new Logsheet { Id = Guid.NewGuid(), Status = ELogSheetStatus.Failed, Template = null!, File = null! };
        var logsheet3 = new Logsheet { Id = Guid.NewGuid(), Status = ELogSheetStatus.Completed, Template = null!, File = null! }; // Invalid state
