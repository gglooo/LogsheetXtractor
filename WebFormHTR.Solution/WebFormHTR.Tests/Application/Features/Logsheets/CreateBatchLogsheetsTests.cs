...
public class CreateBatchLogsheetsTests : IDisposable
{
    ...
    public async Task Handle_ShouldFail_WhenAnyFileAlreadyAssigned()
    {
        ...
        var logsheet = new Logsheet { Id = Guid.NewGuid(), FileId = fileId, TemplateId = Guid.NewGuid(), Template = null!, File = null! };
    ...
    public async Task Handle_ShouldCreateLogsheets_WhenRequestIsValid_WithBackside()
    {
        ...
        var backsideTemplate = new DomainTemplate { Id = backsideTemplateId, Name = "Backside", FileId = backsideTemplateFile.Id };
