...
public class SetTemplateRoisCommandHandlerTests : IDisposable
{
    ...
    public async Task Handle_ShouldSetRois_WhenTemplateExists()
    {
        ...
        _roiServiceMock.Verify(x => x.SetRoisForTemplateAsync(templateId, updateRois, It.IsAny<CancellationToken>()),
            Times.Once);
    }
    ...
    public async Task Handle_ShouldUpsertAndDeleteRois_WhenTemplateExists()
    {
        ...
        var updateRois = new List<SetRoiDto>
        {
            new(existingRoiId, "Updated ROI", ERoiType.Handwritten,
        ...
        var expectedResult = new List<RoiDto>
        {
            ...
            new(Guid.NewGuid(), "New ROI", templateId, ERoiType.Checkbox,
                new Coordinates { X = 10, Y = 10, Width = 20, Height = 20 })
        };
