...
public class AddTemplateBacksideTests : IDisposable
{
    ...
    {
        var frontFile = new Domain.Entities.File
        {
        ...
        var backFile = new Domain.Entities.File
        {
    ...
    public async Task Handle_ShouldReturnError_WhenTemplateIsNotEditable()
    {
        ...
        var logsheetFile = new Domain.Entities.File
        {
        ...
        var backsideFile = new Domain.Entities.File
        {
            OriginalFileName = "back.pdf",
            StoredFileName = "back.pdf",
            StoragePath = "path",
    ...
    public async Task Handle_ShouldCallService_WhenRequestIsValid()
    {
        ...
        _templateServiceMock
            .Setup(s => s.AddBacksideTemplateAsync(template.Id, "Back", backFile.Id, It.IsAny<CancellationToken>()))
        ...
        _templateServiceMock.Verify(
            s => s.AddBacksideTemplateAsync(template.Id, "Back", backFile.Id, It.IsAny<CancellationToken>()),
            Times.Once);
    }
