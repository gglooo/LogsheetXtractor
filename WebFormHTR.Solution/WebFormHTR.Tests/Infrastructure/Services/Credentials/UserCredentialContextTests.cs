...
public class UserCredentialContextTests
{
    ...
    public void Constructor_ShouldSetCredentialPaths()
    {
        ...
        // Act
        var context = new UserCredentialContext(paths, _fileStorageServiceMock.Object, _loggerMock.Object);
    ...
    public async Task DisposeAsync_ShouldHandleExceptionsDuringDeletion()
    {
        ...
        _fileStorageServiceMock.Setup(s => s.DeleteFile("temp/google.json")).Throws(new Exception("Mock exception"));
