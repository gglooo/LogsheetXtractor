...
public sealed class RoiValidationConditionEvaluator(
    IEnumerable<IRoiValidationConditionNodeEvaluator> nodeEvaluators
) : IRoiValidationConditionEvaluator
{
    private readonly IReadOnlyList<IRoiValidationConditionNodeEvaluator> _nodeEvaluators =
        nodeEvaluators.ToList();
    ...
    )
    {
        ...
        return evaluator.Evaluate(
            ...
            context,
            path,
            (child, childPath) => EvaluateNode(child, context, childPath)
        );
    }
