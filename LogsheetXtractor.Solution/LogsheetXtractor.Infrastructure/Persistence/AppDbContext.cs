        ...
        IAppDbContext
{
    ...
    private static readonly ValueComparer<RoiValidationConditionNode?> RoiValidationConditionComparer =
        new(
            (left, right) =>
                SerializeValidationCondition(left) == SerializeValidationCondition(right),
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Roi>(entity =>
        {
            ...
            entity
                .Property(r => r.ValidationCondition)
                .HasConversion(
            ...
            entity
                .HasIndex(r => new { r.TemplateId, r.VariableName })
                .IsUnique()
            ...
            .HasConversion(
                ...
                v =>
                    string.IsNullOrWhiteSpace(v)
                        ...
                        : JsonSerializer.Deserialize<AlignmentContainer>(
                            v,
            ...
            .HasConversion(
                ...
                v =>
                    string.IsNullOrWhiteSpace(v)
                        ...
                        : JsonSerializer.Deserialize<List<RoiValidationWarningSnapshot>>(
                            v,
                            JsonOptions
                        ) ?? new List<RoiValidationWarningSnapshot>()
            );

        modelBuilder.Entity<ExtractedValue>().Property(e => e.ValidationRulesVersion);
        ...
        modelBuilder.Entity<PredefinedRoiValidationCondition>(entity =>
        {
            ...
            entity.Property(p => p.Label).HasMaxLength(128).IsRequired();
