...
namespace LogsheetXtractor.Infrastructure.Persistence.Migrations
{
    ...
    public partial class PersistExtractedValueValidationSnapshot : Migration
    {
        ...
        {
            migrationBuilder.DropColumn(name: "ValidationRulesVersion", table: "ExtractedValues");

            migrationBuilder.DropColumn(name: "ValidationWarnings", table: "ExtractedValues");
        }
    }
}
